# Requerimientos de Software - EducAmbiental

Este directorio contiene la documentación detallada de los requerimientos funcionales y no funcionales del proyecto EducAmbiental, organizada por áreas de responsabilidad.

## Índice de Requerimientos

### 1. [Gestión de Usuarios y Seguridad](requirements/USUARIOS.md)
...
### 6. [Aspectos Técnicos y UI](requirements/TECNICO_UI.md)
Visualización offline, navegación SPA y requerimientos no funcionales (Seguridad, Escalabilidad, etc.).

---

**Proyecto:** EducAmbiental  
**Institución:** Instituto Politécnico Nacional (ESCOM)  
**Materia:** Ingeniería de Software  
**Fecha:** 10 de Mayo de 2026 (Actualizado)
